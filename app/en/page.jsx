          ...
          <div className="absolute top-0 left-0 w-full px-[3rem] h-screen z-10">
            <div className="flex items-center w-full  justify-between ">
              ...
              <div className="pt-[2rem] p-4 flex gap-[5rem] items-center ">
                ...
                <Link href={"/en/signup"}><button className="px-10 bg-orange-500 text-white font-semibold h-[2.5rem] rounded-md">Get Started</button></Link>
              </div>
            </div>
      ...
      <div className="sm:hidden">
        <div className="bgHomeMobile">
          ...
          <div className="absolute bottom-[2rem] p-[2rem]  py-0  " >
            ...
            <Link href={"/en/signup"}><button className="w-[15rem] ml-[calc((100%-15rem)/2)]  mt-[2rem] bg-orange-500 text-white font-semibold h-[2.5rem] rounded-md">Get Started</button></Link>
            <Link href={"/en/dashboard"}><p>home</p></Link>
          </div>
